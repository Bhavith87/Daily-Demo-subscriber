...
const DailySubscribers = () => {
  ...
  useEffect(() => {
    const stored = JSON.parse(localStorage.getItem("dailySubscribers")) || [];
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const newErrors = {};
    const all = JSON.parse(localStorage.getItem("dailySubscribers")) || [];
    ...
    localStorage.setItem("dailySubscribers", JSON.stringify(updated));
